...
var DatabaseDataStorage = /** @class */ (function () {
    ...
    DatabaseDataStorage.prototype.addNote = function (note) {
    ...
    DatabaseDataStorage.prototype.editNoteById = function (noteId) {
        throw new Error('Method not implemented.');
    };
    DatabaseDataStorage.prototype.deleteNoteById = function (noteId) {
        throw new Error('Method not implemented.');
    };
    DatabaseDataStorage.prototype.getPublicNotesByUsername = function (username) {
        throw new Error('Method not implemented.');
    };
    DatabaseDataStorage.prototype.addTag = function (tag) {
        throw new Error('Method not implemented.');
    };
    ...
    DatabaseDataStorage.prototype.editTagById = function (tagId) {
        throw new Error('Method not implemented.');
    };
